...
import raman_mlp
# MLP_train 工具定义
class MLP_train_Input(BaseModel):
...
class custom_MLP_train(BaseTool):
    name = "mlp_train_tool"
    description = '''
        Args: 
        ...
        '''
    args_schema: Type[BaseModel] = MLP_train_Input
    return_direct: bool = False
    ...
    def _run(
        ...
        return raman_mlp.mlp_train(input_file, output_file, criterion, optimizer, hiddens_sizes, activation)
...
class custom_MLP_test(BaseTool):
    ...
    description = '''
        ...
        '''
    args_schema: Type[BaseModel] = MLP_test_Input
    return_direct: bool = False
    ...
    def _run(
        ...
        return raman_mlp.mlp_test(input_str)
...
# MLP_pred 工具定义
class MLP_pred_Input(BaseModel):
...
class custom_MLP_pred(BaseTool):
    name = "mlp_pred_tool"
    description = '''
        Args: 
        ...
        '''
    args_schema: Type[BaseModel] = MLP_pred_Input
    return_direct: bool = False
    ...
    def _run(
        ...
        return raman_mlp.mlp_pred(raman_pump_power, pth)
...
if __name__ == '__main__':
    ...
    mlp_train = custom_MLP_train()
    mlp_test = custom_MLP_test()
    mlp_pred = custom_MLP_pred()
    # print(mlp_pred.run('[0.18, 0.25, 0.17, 0.26, 0.24, 0.13], [64,128],relu,MSELoss,Adam,0.0015.pth'))
    ...
    1. tools: 
        mlp_train(input_str): 
            ...
            - Important: When calling mlp_train, make sure to use the correct format. 
        ...
        mlp_test(input_str):
            ...
            - Important: When calling mlp_test, make sure to use the correct format. 
    ...
    llm = ChatOpenAI(openai_api_key = "your api here", model="gpt-4o-mini", temperature=0)
    tools = [mlp_train, mlp_test, mlp_pred]
