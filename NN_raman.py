...
def NN_train(input_file, output_file, criter, optimal, hidden_size, activation_fn):
    ...
    # hidden_size = [64, 128]
    model = NN(input_size, output_size, hidden_size, activation_fn).to(DEVICE)
...
def NN_test(pth, input_size=6, output_size=10):
    ...
    model = NN(input_size, output_size, hiddens_sizes, activation).to(DEVICE)
...
def NN_pred(input_v, pth, input_size=6, output_size=10):
